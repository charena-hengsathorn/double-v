    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-500 mb-1">Tentative Pipeline</p>
            <p className="text-2xl font-light text-gray-900">-</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-500 mb-1">Risk Exposure</p>
            <p className="text-2xl font-light text-gray-900">-</p>
          </div>
        </div>
        
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Revenue Outlook</h2>
          <div className="h-64 bg-gray-50 rounded flex items-center justify-center text-gray-400">
            Chart placeholder - Stacked area chart will go here
          </div>
        </div>
      </div>
    </main>
