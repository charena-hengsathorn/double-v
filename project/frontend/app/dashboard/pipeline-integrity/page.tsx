...
export default function PipelineIntegrity() {
  ...
  const monthlyTotals = forecast?.forecast?.monthly_totals || forecast?.monthly_totals || [];
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '0.875rem', lineHeight: 1.6, mb: 1.5 }}>
                  <strong>Forecast Metrics:</strong> Generated by the Predictive Service API using a hybrid approach. 
